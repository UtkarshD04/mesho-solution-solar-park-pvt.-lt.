          ...
          <div className="space-y-5">
            ...
            <ul className="space-y-4 text-sm text-white/60">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+918756992444" className="hover:text-[#20b2aa] transition-colors">+91 8756992444</a>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:aseemmishra@gmail.com" className="hover:text-[#20b2aa] transition-colors">aseemmishra@gmail.com</a>
              </li>
